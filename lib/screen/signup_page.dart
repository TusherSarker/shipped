...
class _signupPageState extends State<signupPage> {
  ...
  setShaPref() async {
    ...
    pref.setString("date", (_dateTime!.day).toString()+(_dateTime!.month).toString()+(_dateTime!.year).toString());
          ...
          child: Column(
            children: [
              ...
              Column(
                children: [
                  ListTile(
                    title: Center(child: Text("Welcome to Shipped",
                        style: GoogleFonts.cantataOne(textStyle: TextStyle(
                          fontWeight: FontWeight.bold,fontSize: 24
                        )),
                    )),
                    subtitle: Center(child: Text("please input a valid information")),
                  ),
                  Padding(
                ...
                child: TextButton(
                    onPressed: () {
                      ...
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => loginpagedesign()));
                    },
                    child: Text(
                      "SUBMIT",
