...
class FormalDisplay extends StatefulWidget {
  FormalDisplay({Key? key, this.ProductList, this.Index}) : super(key: key);
  final ProductList;
  final Index;

  @override
  State<FormalDisplay> createState() => _FormalDisplayState();
}

class _FormalDisplayState extends State<FormalDisplay> {
  int counter = 0;
